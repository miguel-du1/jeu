...
public:
  ...
  // Le paramètre `transparenceCouleur` permet de rendre le blanc pur transparent.
  Image(Moteur& moteur, const std::string& nomDuFichier, bool transparenceCouleur = false);
